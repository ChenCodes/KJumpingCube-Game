...
abstract class Board extends Observable {
    ...
    /** Returns an arraylist that holds a bunch of possible moves. */
    abstract ArrayList<Integer> possibleMoves();
    ...
    boolean isLegal(Side player, int n) {
        Square currSquare = this.get(n);
        if (currSquare.getSide() == player || currSquare.getSide()
            == Side.WHITE) {
            return true;
        }
        return false;
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.size(); i++) {
            ...
            for (int j = 0; j < this.size(); j++) {
                ...
                printt2((this.get(i + 1, j + 1)).getSpots());
                if (this.get(i + 1, j + 1).getSide().equals(WHITE)) {
                    printt2("-");
                } else if (this.get(i + 1, j + 1).getSide().equals(RED)) {
                    printt2("r");
                } else if (this.get(i + 1, j + 1).getSide().equals(BLUE)) {
                    printt2("b");
                }
                if (j == this.size() - 1) {
                    printt2("");
    ...
    /** This is an efficient print method.
        * @param s This holds an object to be printed.
        */
    public static void printt(Object s) {
        System.out.println(s);
    }

    /** This is another efficient print method.
        * @param s This holds an object to printed.
         */
    public static void printt2(Object s) {
        System.out.print(s);
    }
